    ...
    return(
        <li ref={ref} className='my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col items-center justify-between md:my-4 md:w-[65%]'>
            ...
            <motion.div initial={{y:50}} whileInView={{y:0}} transition={{duration: 0.5, type:"spring"}} >
                <h3 className='capitalize font-bold text-2xl md:text-xl'>{cert_name}<br/><a href={link} target="_blank" className='text-primary cursor-pointer capitalize dark:text-primaryDark'>{provider}</a></h3>
